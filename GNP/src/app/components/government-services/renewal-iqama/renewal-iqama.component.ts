...
@Component({
  selector: 'app-renewal-iqama',
  templateUrl: './renewal-iqama.component.html',
  styleUrls: ['./renewal-iqama.component.css']
})
export class RenewalIqamaComponent implements OnInit {
